...
public class TNTControlConfig extends Configs {
	...
	public enum Messages {
		...
		INFO_TNT_ALLOW_REDSTONE_PRIME("TNT can be primed by redstone: %onOff", "Infoe Messages to display if TNT can be exploded by redstone"),
...
// Default Config Variables start here!
	...
	private boolean tntAllowRedstonePrime = true;
	private final String TNT_ALLOW_REDSTONE_PRIME = "tntAllowRedstonePrime";
...
// And than we add the defaults
	...
	void customDefaultConfig() {
		...
		config.addDefault(TNT_ALLOW_REDSTONE_PRIME, tntAllowRedstonePrime);
...
// Than we load it....
	...
	void loadCustomConfig() {
		...
		tntAllowRedstonePrime = config.getBoolean(TNT_ALLOW_REDSTONE_PRIME);
...
// first the options
		...
		stream.println("# Allow detonating TNT with Redstone");
		stream.println("# NOTE: If you DISABLE this you will also disable any detonation caused by moved TNT, aka chain explosions!");
		stream.println(TNT_ALLOW_REDSTONE_PRIME + ": " + tntAllowRedstonePrime);
...
// ToDO Add your getters and setters for your config variables here.
	...
	public boolean isTntAllowRedstonePrime() {
		return tntAllowRedstonePrime;
	}

	public void setTntAllowRedstonePrime(boolean tntAllowRedstonePrime) {
		this.tntAllowRedstonePrime = tntAllowRedstonePrime;
	}
