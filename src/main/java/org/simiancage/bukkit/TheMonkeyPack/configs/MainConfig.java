...
// These are the modules which can be enabled.
	...
	private final String ENABLE_RARP = "enableRARP";
	private final String MODULE_NAME_RARP = "RaRP";
	private boolean enableRARP = false;
	public static RARPConfig rarpConfig;
...
// ToDo Start here loading the configuration into your config variables
		...
		enableRARP = config.getBoolean(ENABLE_RARP);
		...
		log.debug(ENABLE_RARP, enableRARP);
...
//Start here writing your config variables into the config file inkl. all comments
		...
		stream.println();
		stream.println("#-------- Module [" + MODULE_NAME_RARP + "] --------");
		stream.println();
		stream.println("# Redstone and Rail Protection against Water, Lava and Pistonmovement");
		stream.println(ENABLE_RARP + ": " + enableRARP);
		stream.println();
...
// ToDO Add your getters and setters for your config variables here.
	...
	public static void setRarpConfig(RARPConfig rarpConfig) {
		MainConfig.rarpConfig = rarpConfig;
	}
	...
	public String getMODULE_NAME_RARP() {
		return MODULE_NAME_RARP;
	}
	...
	public boolean isEnableRARP() {
		return enableRARP;
	}

	public void setEnableRARP(boolean enableRARP) {
		this.enableRARP = enableRARP;
	}
